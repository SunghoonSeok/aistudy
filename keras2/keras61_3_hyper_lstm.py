...
acc = search.score(x_test, y_test) # epochs default 1
print("최종 스코어 :", acc)
print(search.best_params_) # 내가 선택한 파라미터들
# print(search.best_estimator_) # 모든 파라미터들 근데 케라스 파라미터 인식을 못해
print(search.best_score_)

# 최종 스코어 : 0.9487000107765198
# {'optimizer': <class 'tensorflow.python.keras.optimizer_v2.adam.Adam'>, 'node2': 128, 'node1': 128, 'lr': 0.005, 'drop': 0.2, 'batch_size': 
# 64, 'activation': 'tanh'}
# 0.94050000111262
